...
namespace Scaffolding.Data
{
    public partial class ApplicationDbContext : DbContext
    {
        ...
        public virtual DbSet<OrdersCompleted> OrdersCompleteds { get; set; } = null!;
        public virtual DbSet<OrdersCompletedN> OrdersCompletedNs { get; set; } = null!;
        ...
        public virtual DbSet<T2> T2s { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderItem>(entity =>
            {
                entity.HasKey(e => new { e.OrderId, e.ItemId })
                    .HasName("PK__order_it__837942D4BCD1CB07");
            ...
            modelBuilder.Entity<OrdersCompleted>(entity =>
            {
                entity.HasKey(e => e.OrderId)
                    .HasName("PK__orders_c__46596229F36F05E9");

                entity.ToTable("orders_completed", "sales");
            ...
            modelBuilder.Entity<OrdersCompletedN>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("orders_completed_n", "sales");
            ...
            modelBuilder.Entity<ProductAudit>(entity =>
            {
                entity.HasKey(e => e.ChangeId)
                    .HasName("PK__product___F4EFE5966DE7B4C6");
            ...
            modelBuilder.Entity<Stock>(entity =>
            {
                entity.HasKey(e => new { e.StoreId, e.ProductId })
                    .HasName("PK__stocks__E68284D3F61078E5");
